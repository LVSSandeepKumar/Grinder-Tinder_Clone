...
const ProfilePage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    updateProfile({ name, bio, age, gender, image });
  };
  ...
  return (
    <div className="flex flex-col bg-gray-50 min-h-screen">
      ...
      <div className="flex-grow flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 m:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-4 border border-gray-200">
