  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-500 to-pink-500 p-4">
      <div className="w-full max-w-md">
        <h2 className="text-center text-3xl text-white font-extrabold mb-8">
          {isLogin ? "Sign in to Grinder account" : "Create new Grinder account"}
        </h2>
        ...
        <div className="bg-white shadow-xl rounded-lg p-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              {isLogin ? "New to Grinder?" : "Already have an account?"}
            </p>
            <button
